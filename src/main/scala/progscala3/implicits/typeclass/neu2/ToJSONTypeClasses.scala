// src/main/scala/progscala3/implicits/typeclass/neu2/ToJSONTypeClasses.scala
package progscala3.implicits.typeclass.neu2
...
given ToJSON[Shape]:
  extension (shape: Shape) def toJSON(level: Int): String = shape match
    case c: Circle    => given_ToJSON_Circle.extension_toJSON(c)(level)
    case r: Rectangle => given_ToJSON_Rectangle.extension_toJSON(r)(level)
    case t: Triangle  => given_ToJSON_Triangle.extension_toJSON(t)(level)
