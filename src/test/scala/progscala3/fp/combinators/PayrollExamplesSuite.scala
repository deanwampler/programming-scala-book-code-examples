// src/test/scala/progscala3/fp/combinators/PayrollExamplesSuite.scala
package progscala3.fp.combinators

import munit._

class PayrollExamplesSuite extends FunSuite {
  ...
  test("netPay computes pay for each employee") {
  ...
  test("from netPay, the totals can be calculated") {
